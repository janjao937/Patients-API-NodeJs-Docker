...
export const createPatient = async (req: Request, res: Response): Promise<Response<Patient[]>> => {
    ...
    try {
        ...
        return res.status(Code.CREATED).send(new HttpResponse(Code.CREATED, Status.CREATED, "Patients retrieved", patient));
...
export const updatePatient = async (req: Request, res: Response): Promise<Response<Patient[]>> => {
    ...
    try {
        ...
        if ((result[0] as Array<ResultSet>).length > 0) {
            ...
            return res.status(Code.OK).send(new HttpResponse(Code.OK, Status.OK, "Patients updated", { ...patient, id: req.params.patientId }));
        } else {
...
export const deletePatient = async (req: Request, res: Response): Promise<Response<Patient[]>> => {
    ...
    try {
        ...
        if ((result[0] as Array<ResultSet>).length > 0) {
            ...
            return res.status(Code.OK).send(new HttpResponse(Code.OK, Status.OK, "Patients deleted"));
        } else {
